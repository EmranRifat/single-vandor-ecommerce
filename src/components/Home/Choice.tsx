    ...
    return (
        <section className="bg-gradient-to-br from-rose-50 via-white to-pink-50 py-16">
            <div className="mx-auto max-w-7xl px-5">
                ...
                <div className="mt-5 text-center">
                    <h2 className="text-3xl font-bold text-slate-900 md:text-5xl">
                        Why Homely is Your{" "}
                        <span className="text-pink-500">Best Choice?</span>
                    </h2>

                    <div className="mx-auto mt-4 h-1 w-20 rounded-full bg-gradient-to-r from-pink-500 to-rose-300"></div>
                </div>
                ...
                <div className="mt-14 grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
                    {features.map((item) => (
                        <div
                            key={item.id}
                            className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-5 min-h-[260px] transition-all duration-300 hover:-translate-y-2 hover:border-pink-300 hover:shadow-xl"
                        >
                            {/* Top */}
                            <div className="mb-5 flex items-center justify-between">
                                ...
                                <span className="text-5xl font-bold text-gray-100 transition group-hover:text-pink-100">
                                    {item.id}
                                </span>
                            </div>

                            {/* Title */}
                            <h3 className="mb-3 text-lg font-semibold leading-7 text-slate-900">
                                {item.title}
                            </h3>
                            ...
                            {/* Bottom Hover Line */}
                            <div className="absolute bottom-0 left-0 h-1 w-0 bg-gradient-to-r from-pink-500 to-rose-400 transition-all duration-500 group-hover:w-full"></div>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="mt-8 flex flex-col items-center">
                <p className="text-center text-sm font-medium text-gray-500 md:text-base">
